...
SELECT  
    ...
    p.PRODUCT_NAME,
    p.PRODUCT_TYPE,
    p.PRODUCT_PRICE_DOLLARS as PRODUCT_PRICE,
    o.ORDERED_AT,
    o.ORDER_STORE_ID,
    o.ORDER_SUBTOTAL,
    o.ORDER_TAX_PAID,
    ...
    p.PRODUCT_PRICE_DOLLARS as ITEM_PRICE,
    CASE 
        WHEN o.ORDER_SUBTOTAL > 0 AND p.PRODUCT_PRICE_DOLLARS IS NOT NULL
            THEN (CAST(i.ITEM_ID AS FLOAT) * p.PRODUCT_PRICE_DOLLARS / NULLIF(o.ORDER_SUBTOTAL, 0))
        ELSE 0
    END as ITEM_AMOUNT,
